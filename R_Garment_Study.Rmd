...
```{r}
data_1 <- select(data, -c(date,wip,over_time,incentive,idle_time,no_of_workers,actual_productivity))
# Para generar el csv
write.csv(data_1,paste(dir,"tidy_dataset.csv", sep=""),row.names = TRUE)
```
